...
class RandomHexagonGridTransition extends Transition {
  final Color? color;
  ...
  @override
  State<RandomHexagonGridTransition> createState() =>
      _RandomHexagonGridTransitionState();
}

class _RandomHexagonGridTransitionState
    extends TransitionState<RandomHexagonGridTransition>
        ...
        builder: (context, constraints) {
          ...
          return AnimatedBuilder(
            ...
            builder: (context, child) {
              ...
              return CustomPaint(
                painter: RandomHexagonGridPainter(
                  hexagons: _hexagons,
                  progress: progress,
...
class RandomHexagonGridPainter extends CustomPainter {
  final List<_HexagonTile> hexagons;
  final double progress;
  final bool isExiting;
  final TransitionExitMode exitMode;

  RandomHexagonGridPainter({
  ...
  @override
  bool shouldRepaint(covariant RandomHexagonGridPainter oldDelegate) {
